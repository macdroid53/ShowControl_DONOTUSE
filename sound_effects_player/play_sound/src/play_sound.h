...
GType
play_sound_get_type (void) G_GNUC_CONST; Play_Sound *play_sound_new (void);
...
GtkWindow *play_sound_get_top_window (GApplication * app);

/* Given the application, find the parameter file. */
GKeyFile *play_sound_get_parameter_file (GApplication * app);

/* Given the application, store the parameter file. */
void play_sound_set_parameter_file (GKeyFile * parameter_file,
                                    GApplication * app);
