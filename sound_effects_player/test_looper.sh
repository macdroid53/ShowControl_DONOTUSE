...
gst-launch-1.0 --gst-debug=*:6 -v -m filesrc location=test.wav ! wavparse ! looper autostart=TRUE file-location=/home/jsauter/Projects/show_control/sound_effects_player/test.wav loop-from=500000000 loop-limit=10 ! audioconvert ! audio/x-raw,format=F32LE ! wavenc ! filesink location=output.wav
